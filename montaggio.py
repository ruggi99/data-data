...
# crea_montaggio(squadra="*", numero="10", fond="A", nome="Attacco Consolini")
# crea_montaggio(squadra="*", numero="12", fond="A", nome="Attacco Dietre")
...
crea_montaggio(squadra="*", numero="01", fond="R", nome="Ricezione Cristofaletti")
crea_montaggio(squadra="*", numero="02", fond="R", nome="Ricezione Nanfito")
crea_montaggio(squadra="*", numero="04", fond="R", nome="Ricezione Coser")
crea_montaggio(squadra="*", numero="11", fond="R", nome="Ricezione Pedrolli")
crea_montaggio(squadra="*", numero="12", fond="R", nome="Ricezione Dietre")
crea_montaggio(squadra="*", numero="15", fond="R", nome="Ricezione Polacco")
crea_montaggio(squadra="*", numero="17", fond="R", nome="Ricezione Thei")
crea_montaggio(squadra="*", numero="18", fond="R", nome="Ricezione Gasperi")
